    ...
    >
      ...
      {content.description || isEditing ? (
        <p
          ...
          onMouseDown={(e) => isEditing && e.stopPropagation()}
          className={`text-base md:text-lg text-white/70 mt-4 outline-none focus:bg-transparent rounded px-2 -mx-2 text-left ${isEditing ? 'cursor-text' : ''} [&_a]:underline [&_a]:text-white/90`}
